...
android {
    ...
    buildTypes {
        getByName("release") {
            // Debug signing is used here so that CI can produce an installable APK
            // without requiring a keystore secret. Replace with a real signingConfig
...
dependencies {
    ...
    // Coroutines for non-blocking channel operations
